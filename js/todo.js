...
function handleToDoSubmit(e) {
  ...
  toDos.push(newToDoObj) // 빈 배열에 input value 값 넣기
  paintTodo(newToDoObj) // input value값을 그려내는 함수 실행
...
function handleDeleteToDo(e) {
  ...
  toDos = toDos.filter((el) => el.id !== parseInt(e.target.parentElement.id))
  saveToDos()
}
